/* */ 
define(['exports', 'core-js', 'aurelia-logging', 'aurelia-dependency-injection', 'aurelia-pal', 'aurelia-route-recognizer', 'aurelia-history', 'aurelia-event-aggregator'], function (exports, _coreJs, _aureliaLogging, _aureliaDependencyInjection, _aureliaPal, _aureliaRouteRecognizer, _aureliaHistory, _aureliaEventAggregator) {
  'use strict';
        ...
        var _ret5 = (function () {
          ...
          if ('configureRouter' in viewModel) {
            if (!_this7.isConfigured) {
              return {
                v: _this7.configure(function (config) {
