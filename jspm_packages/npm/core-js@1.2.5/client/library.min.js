...
(function(process) {
  !function(b, c, a) {
    ...
    !function(b) {
      ...
      })), d(d.G + d.W + d.F * !f, {Promise: c}), b(35)(c, e), b(117)(e), o = b(13)[e], d(d.S + d.F * !f, e, {reject: function reject(a) {
      ...
      var g = b(7),
          ...
          i = b(3),
          n = b(35);
      f.exports = function(f, s, w, r, p, o) {
        var t = g[f],
            b = t,
            u = p ? "set" : "add",
            q = b && b.prototype,
            v = {};
        return i && "function" == typeof b && (o || q.forEach && !h(function() {
          (new b).entries().next();
        })) ? (b = s(function(c, d) {
          l(c, b, f), c._c = new t, d != a && k(d, p, c[u], c);
          ...
          c in q && (!o || "clear" != c) && e(b.prototype, c, function(b, e) {
            ...
            return this._c.size;
          }})) : (b = r.getConstructor(s, f, p, u), j(b.prototype, w)), n(b, f), v[f] = b, c(c.G + c.W + c.F, v), o || r.setStrong(b, f, p), b;
      };
    }, function(d, e, b) {
      var c = b(132);
 ...
 while (!d(e, c = f[b._i++]));
      ...
      var c = a(173),
          b = a(12);
      a(13)._ = c._ = c._ || {}, b(b.P + b.F, "Function", {part: a(172)});
    }, function(c, d, b) {
      var a = b(12);
