...
(function(process) {
  !function(__e, __g, undefined) {
    ...
    (function(modules) {
      ...
      $def($def.S, 'Array', {isArray: __webpack_require__(27)});
      ...
      var $def = __webpack_require__(12),
          ...
          ENDS_WITH = 'endsWith',
          $endsWith = ''[ENDS_WITH];
      $def($def.P + $def.F * __webpack_require__(102)(ENDS_WITH), 'String', {endsWith: function endsWith(searchString) {
      ...
      var $def = __webpack_require__(12),
          context = __webpack_require__(100),
          INCLUDES = 'includes';
      $def($def.P + $def.F * __webpack_require__(102)(INCLUDES), 'String', {includes: function includes(searchString) {
          return !!~context(this, searchString, INCLUDES).indexOf(searchString, arguments.length > 1 ? arguments[1] : undefined);
        }});
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(12);
      $def($def.P, 'String', {repeat: __webpack_require__(105)});
    }, function(module, exports, __webpack_require__) {
      'use strict';
      var toInteger = __webpack_require__(25),
          defined = __webpack_require__(23);
      ...
      $def($def.P + $def.F * __webpack_require__(102)(STARTS_WITH), 'String', {startsWith: function startsWith(searchString) {
      ...
      var $ = __webpack_require__(2),
          ...
          setToStringTag = __webpack_require__(35),
          IteratorPrototype = {};
      __webpack_require__(14)(IteratorPrototype, __webpack_require__(28)('iterator'), function() {
        return this;
      });
      ...
      $def($def.S + $def.F * !__webpack_require__(115)(function(iter) {
        Array.from(iter);
      ...
      'use strict';
      var $def = __webpack_require__(12);
      $def($def.P, 'Array', {copyWithin: __webpack_require__(123)});
      ...
      var $def = __webpack_require__(12);
      $def($def.P, 'Array', {fill: __webpack_require__(125)});
      ...
      $def($def.P + $def.F, 'Function', {part: __webpack_require__(184)});
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(12);
      $def($def.S + $def.F, 'Object', {isObject: __webpack_require__(9)});
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(12);
      $def($def.S + $def.F, 'Object', {classof: __webpack_require__(47)});
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(12),
      ...
      'use strict';
      var $def = __webpack_require__(12),
          $re = __webpack_require__(173)(/&(?:amp|lt|gt|quot|apos);/g, {
            '&amp;': '&',
            '&lt;': '<',
            '&gt;': '>',
            '&quot;': '"',
