...
var ARRAY_NAMES = ('Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,' + 'Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array').split(',');
...
var $getDesc = function getOwnPropertyDescriptor(target, key) {
  return isTADesc(target, key = toPrimitive(key, true)) ? propertyDesc(2, target[key]) : getDesc(target, key);
};
