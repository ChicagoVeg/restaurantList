...
var proto = {
  ...
  slice: function slice(start, end) {
    return fromList(this, $slice.call(validate(this), start, end));
  },
...
var isTADesc = function(target, key) {
  return isObject(target) && TYPED_ARRAY in target && (typeof key == 'string' || typeof key == 'number') && isInteger(+key);
};
...
DEBUG && ('Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,' + 'Uint32Array,Float32Array,Float64Array').split(',').forEach(function(it) {
  delete global[it];
});
module.exports = function(KEY, BYTES, wrapper, CLAMPED) {
  ...
  TAG in $TypedArray.prototype || $.setDesc($TypedArray.prototype, TAG, {get: function() {
      return NAME;
    }});
